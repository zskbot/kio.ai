...
agentStatus.classList.add("status-working");

if (agentPanel) {
agentPanel.classList.add("is-tracing");
}

} else {

if (agentPanel) {
agentPanel.classList.remove("is-tracing");
}

if (status === "DONE") {
agentStatus.classList.add("status-done");
}

if (status === "ERROR") {
agentStatus.classList.add("status-error");
}
